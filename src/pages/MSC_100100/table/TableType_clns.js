...
import { LUXInputField, LUXRadioButton, LUXRadioButtonGroup, LUXTextArea } from "luna-rocket";
...
export default function () {
  ...
  const { etnl_obsr_opnn_list, dre_opnn_list, obsr_opnn_site_2, rslt_opnn_list } = useMSC100100Store(
    ...
    <div className="LUX_basic_tbl">
      <table className="tblarea2 tblarea2_v2 tblarea2_v3">
        ...
        <tbody>
                ...
                <div className="tblConBox clearfix">
                  ...
                  >
                    {obsr_opnn_site_2.map(item => (
                      <LUXRadioButton value={item.value} labelText={item.text} style={{ marginRight: "8px" }} />
                    ))}
                  </LUXRadioButtonGroup>
                </div>
          ...
          <tr>
            <th scope="row" className="celcnt" rowSpan="3">
              진단결과
            </th>
            <th scope="row" className="celcnt">
              결과소견1
            </th>
            <td>
              <CustomStyledSmartPicker
